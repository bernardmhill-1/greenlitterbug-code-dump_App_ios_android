...
export default class ProductDetails extends React.Component {
  ...
  render() {
    return (
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal:15, marginBottom: 80 }}>
        <View style={{ backgroundColor: '#fefefe', borderRadius: 15, elevation: 5, height: 127, width: 148,shadowColor: 'gray', shadowOpacity: 0.8, shadowRadius: 2, shadowOffset: { height: 1, width: 0 } }} >
          ...
          <Text style={{ textAlign: 'center', color: 'gray', fontFamily: 'WS-SemiBold', fontSize: 12, marginTop: 5 }}>{this.props.companyName}</Text>
        </View>
      </View>
