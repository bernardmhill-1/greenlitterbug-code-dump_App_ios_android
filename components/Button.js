    ...
    <View style={{ width: '100%' }}>
      ...
      >
        <LinearGradient
          ...
          style={[ margin === "zero" ? {marginHorizontal:10,paddingVertical: 15, borderRadius: 30} : {marginHorizontal:40,paddingVertical: 15, borderRadius: 30}]}
          start={{ x: 0, y: 1 }}
          end={{ x: 1, y: 1 }}
        >
          <Text
    ...
    <View style={{ width: '100%' }}>
      ...
      >
        <LinearGradient
          ...
          style={{marginHorizontal:30,paddingVertical: 10, borderRadius: 30}}
          start={{ x: 0, y: 1 }}
          end={{ x: 1, y: 1 }}
        >
          <Text
